...
CASE_CONFIGS: Dict[str, CaseConfig] = {
    "brain": CaseConfig(
        ...
        compile_commands=(
            ("cmake", "-S", ".", "-B", "build/brain"),
            ("cmake", "--build", "build/brain", "--target", "main"),
        ),
        material_labels={
            0: "gray_matter",
            1: "CSF",
    ...
    "breast": CaseConfig(
        key="breast",
        label="Breast",
        build_dir=REPO_ROOT / "build" / "breast",
        binary_name="main",
        default_mesh="mesh/breast/breast_128_augmented.msh",
        compile_commands=(
            ("cmake", "-S", ".", "-B", "build/breast"),
            ("cmake", "--build", "build/breast", "--target", "main"),
        ),
        material_labels={
            1: "skin",
            2: "fat",
